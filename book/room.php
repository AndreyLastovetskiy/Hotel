   ...
   <!-- room -->
    ...
    <section class="room" id="room">
        <div class="room-heading">
            <h1 class="heading" style="color: #0077b6;"><?= $select_offer['name']; ?></h1>
            <?php
            if(empty($_COOKIE['id_user'])) {
                echo "";
            } elseif($_COOKIE['id_group'] == 1) { ?>
                <a href="./edit_room.php?id=<?= $select_offer['id']; ?>" style="color: #0077b6;"><i class="fa-solid fa-pen-to-square fa-2xl"></i></a>
                <a href="./delete_room.php?id=<?= $select_offer['id']; ?>" style="color: #0077b6;"><i class="fa-solid fa-trash fa-2xl"></i></a>
            <?php } ?>
            
        </div>
        
        <div class="room-wrapper-fl">
            <div class="rw-left">
                <img src="<?= "../" . $select_offer['image_path']; ?>">
            </div>
            <div class="rw-right">
                <p><?= $select_offer['descrip']; ?></p>
                <p>Количество комнат: <?= $select_offer['rooms']; ?></p>
                <p><?= $select_offer['price']; ?></p>
                <a href="./book.php?id=<?= $select_offer['id']; ?>">Забронировать</a>
            </div>
        </div>
